      ...
      <ThemeProvider theme={theme}>
        <BrowserRouter basename={`/${process.env.PUBLIC_URL}`}>
          ...
          <Routes>
            ...
            <Route path="/dashboard-swe" element={<Dashboard valid_until_date={new Date(2022, 10, 14)} street_address='3127 TAMU' city='College Station' state="TX" zip_code={77843} fund_name="947490-SWE"/>} />
