      ...
      <ThemeProvider theme={theme}>
        <BrowserRouter basename={`/${process.env.PUBLIC_URL}`}>
          ...
          <Routes>
            ...
            <Route path="/how-it-works" element={<HowItWorks organization={''} student_org_short_name = {""} />} />
            <Route path="/faq-swe" element={<FAQ student_org_logo={SWELogo} student_org_name="Society of Women Engineers" student_org_short_name= "SWE" />} />
            <Route path="/levels-swe" element={<Levels student_org_logo={SWELogo} student_org_name="Society of Women Engineers" />} />
            ...
            <Route path="/checkout-swe" element={<Checkout student_org_logo={SWELogo} level_color="ebeaea" student_org_name ="Society of Women Engineers" level_name='Platinum' total={4250}/>} />
            <Route path="/inbox-swe" element={<Inbox student_org_logo={SWELogo} student_org_name="Society of Women Engineers" />} />

            <Route path="/faq-edit-swe" element={<EditFAQ student_org_logo={SWELogo} student_org_short_name= "SWE" student_org_name="Society of Women Engineers" />} />
            ...
            <Route path="/summary-swe" element={<PurchaseHistory student_org_logo={SWELogo}  total_sponsored={50000} student_org_name="Society of Women Engineers"  />} />
